...
## Lore
Viande et poisson mijotés dans la même marmite.

## Intégration Bot
- Joueur : `!marmite …` (obtention) · `!manger CSM_CUI_009` — GM : `!sys_give CSM_CUI_009 [Num]` — IA : `SYS_GRANT_ITEM(Avatar_ID, CSM_CUI_009, 1)`
