...
## Lore
Des légumes et herbes rôtis, parfumés par la flamme.

## Intégration Bot
- Joueur : `!marmite …` (obtention) · `!manger CSM_CUI_005` — GM : `!sys_give CSM_CUI_005 [Num]` — IA : `SYS_GRANT_ITEM(Avatar_ID, CSM_CUI_005, 1)`
