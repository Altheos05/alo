...
const INTENT_PATTERNS = [
  ...
  { intent: 'EFFECTS', pattern: /^!?effets$/i },
  { intent: 'FLEE', pattern: /^!?(?:fuite|fuir|flee)$/i },
  { intent: 'ASK', pattern: /^!?demander\b.*/i },
  { intent: 'MARMITE', pattern: /^!?marmite\b.*/i },
  { intent: 'GIFT', pattern: /^!?offrir\b.*/i },
  { intent: 'USE_ITEM', pattern: /^!?(?:use|manger|boire|consommer)\s+.+/i },
  { intent: 'USE_SKILL', pattern: /^!?music\b.*/i },
...
export function getAgentForIntent(intent) {
  const map = {
    ...
    DIPLOMACY: 'lore', HOUSING: 'player', MENU: 'system', MARRIAGE: 'social', REPAIR: 'economy', GATHER: 'economy', EFFECTS: 'player', FLEE: 'combat', ASK: 'dialogue', USE_ITEM: 'player', MARMITE: 'economy', GIFT: 'social', FLIGHT: 'player', INSPECT: 'player', DROP_ITEM: 'player',
