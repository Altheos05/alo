...
export function getAgentForIntent(intent) {
  const map = {
    ...
    DIPLOMACY: 'lore', HOUSING: 'player', MENU: 'system', MARRIAGE: 'social', REPAIR: 'economy', GATHER: 'economy', EFFECTS: 'player', FLEE: 'combat', ASK: 'dialogue', USE_ITEM: 'player', MARMITE: 'economy', FLIGHT: 'player', INSPECT: 'player', DROP_ITEM: 'player',
