...
## Lore
Viande et végétaux enfilés sur une broche, grillés ensemble.

## Intégration Bot
- Joueur : `!marmite …` (obtention) · `!manger CSM_CUI_007` — GM : `!sys_give CSM_CUI_007 [Num]` — IA : `SYS_GRANT_ITEM(Avatar_ID, CSM_CUI_007, 1)`
