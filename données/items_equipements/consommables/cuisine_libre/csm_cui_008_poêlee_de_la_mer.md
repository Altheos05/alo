...
## Lore
Poisson et légumes sautés à la poêle.

## Intégration Bot
- Joueur : `!marmite …` (obtention) · `!manger CSM_CUI_008` — GM : `!sys_give CSM_CUI_008 [Num]` — IA : `SYS_GRANT_ITEM(Avatar_ID, CSM_CUI_008, 1)`
